...
<html lang="en">
    ...
    <body>
        ...
        <!-- Loader -->
    	<?php include 'assets/scripts/views/loader.php';?>

		<!-- Top menu -->
        <?php //include 'assets/scripts/views/top_menu.php';?>

        <!-- Top content -->
        <?php include 'assets/scripts/views/top_content.php';?>

        <!-- Features -->
        <?php //include 'assets/scripts/views/features.php';?>

		<!-- More features -->
        <?php include 'assets/scripts/views/more_features.php';?>

        <!-- Great support -->
        <?php //include 'assets/scripts/views/support.php';?>

        <!-- How it works -->
        <?php //include 'assets/scripts/views/how_it_work.php';?>

        <!-- Testimonials -->
        <?php //include 'assets/scripts/views/testimonials.php';?>
